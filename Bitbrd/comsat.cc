...
//////////////////////////////////////////////////////
// > perft 1
void Perft::exec( const vector <string> &args ){
  auto depth = stoi( args[1] );
  Search( comsat.node ).perft_fork( depth );
}
//////////////////////////////////////////////////////
// > fen  
void Fen::exec( const vector <string> &args ){
  cout << comsat.node.getfen() << nl;
}
//////////////////////////////////////////////////////
//////////////////////////////////////////////////////
//////////////////////////////////////////////////////
